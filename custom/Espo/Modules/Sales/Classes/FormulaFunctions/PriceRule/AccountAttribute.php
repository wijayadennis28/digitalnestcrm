...
class AccountAttribute extends BaseFunction implements InjectableFactoryAware
{
    ...
    public function process(ArgumentList $args)
    {
        ...
        if (!property_exists($variables, '__account')) {
            throw new Error("ext\\priceRule\\accountAttribute called in a wrong context.");
        }

        $entity = $variables->__account;
