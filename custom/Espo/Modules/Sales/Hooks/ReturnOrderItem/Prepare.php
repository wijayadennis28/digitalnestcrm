...
namespace Espo\Modules\Sales\Hooks\ReturnOrderItem;
...
{
    /**
     * @param QuoteItem $entity
     */
    public function beforeSave(Entity $entity): void
    {
        $this->processSetWeight($entity);
    }

    private function processSetWeight(QuoteItem $entity): void
    {
