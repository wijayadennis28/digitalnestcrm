...
class ReceiptOrderItem extends QuoteItem
{
    public const ENTITY_TYPE = 'ReceiptOrderItem';
    ...
    public function setQuantityReceived(?float $value): self
    {
        $this->set('quantityReceived', $value);
